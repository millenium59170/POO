...
$bankAccount01->depositMoney(10000); // Matthieu a 1000 sur son compte
echo $bankAccount01->getBalance(); // Renvoie 1000
$bankAccount01->withdrawMoney(10000); // Matthieu a 0 sur son compte
...
$savingAccount01->depositMoney(10000); // Matthieu a 1000 sur son livret
$savingAccount01->withdrawMoney(10000); // Matthieu a 0 sur son livret
...
// On vire 10000 de $bankAccount01 à $savingAccount01
